        ...
        <div className='relative group flex items-center hover:bg-black/5 p-4 transition w-full'>
            <div className='group flex gap-2 items-start w-full'>
                ...
                <div className='flex flex-col w-full'>
                    <div className='flex items-center gap-x-2'>
                        ...
                        <span className='text-xs taxt-zinc-500 dark:text-zinc-400'>
                            {timestamp}
                        </span>
                    </div>
                    {isImage && (
                        <a
                            ...
                            imtems-center bg-secondary h-48 w-48'
                        >
                            <Image
                                src={fileUrl}
                                alt={content}
            ...
            </div>
            {
                canDeleteMessage && (
                    ...
                    >
                        {canEditMessage && (
                            <ActionTooltip side='right' label='Edit'>
                                <Edit
                        ...
                        <ActionTooltip side='right' label='Delete'>
                            <Trash
                                className='cursor-pointer ml-auto w-4 h-4 text-zinc-500 
                                    hover:text-zinc-600 dark:hover:text-zinc-300 transition'
                            />
